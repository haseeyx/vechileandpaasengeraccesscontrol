...
{/*  Passenger Entry  Section */}
 <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 mt-8">
          <h2 className="text-2xl font-bold font-bold text-indigo-800 mb-4"> Passenger Detail</h2>
          <form>
            <div className="mb-4">
...
<div className="bg-white/90 backdrop-blur-xl rounded-xl shadow-lg p-4 mb-4">
    ...
    <div className="form-container flex justify-center mt-6">
  <button
    type="button"
    className="w-1/2 inline-flex justify-center py-2 px-3 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
...
<div className="form-container flex justify-center mt-4">
  <button
    type="button"
    className="w-1/2 inline-flex justify-center py-2 px-3 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
